...
//       {/* Dropdown nav */}
//       {menuOpen && (
//         <nav className="border-t border-black/10 bg-white px-6 py-6 flex flex-col gap-4 text-sm text-black">
//           <a href="#work" onClick={() => setMenuOpen(false)} className="hover:text-black/60">
//             Works
//           </a>
//           <a href="#about" onClick={() => setMenuOpen(false)} className="hover:text-black/60">
//             About
//           </a>
//           <a href={`mailto:${email}`} className="hover:text-black/60">
//             Contact
